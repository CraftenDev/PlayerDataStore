...
public class MemoryPlayerDataStoreTest {
    private MemoryPlayerDataStore store;
    private MemoryPlayerDataStore secondStore;

    @Before
    public void setup() throws URISyntaxException {
        ConfigurationSection memory = new MemoryConfiguration();
        store = new MemoryPlayerDataStore(memory, UUID.randomUUID());
        secondStore = new MemoryPlayerDataStore(memory, UUID.randomUUID());
    }
